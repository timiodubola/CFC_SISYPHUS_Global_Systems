...
class App{
	...
	baseFloodElevationMsg(){
	   ...
	   const texture = new THREE.TextureLoader().load( '../static/img/floodElev.png' );
	...
	addOurScanner(){
		...
		const texture = new THREE.TextureLoader().load( '../static/img/scanner.png' );
    ...
    initScene(){
		...
		const logI = new THREE.TextureLoader().load( '../static/img/instruct_home.png' );
		...
		// Add our Flood Zone
		const logFZ = new THREE.TextureLoader().load( '../static/img/flood_zone.png' );
